...
connectDatabase(){
    ...
    case $1 in
	   ...
	   conn ${ORAUSER}/${ORAPASS}@'(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.5.15)(PORT=1521))(CONNECT_DATA = (SERVICE_NAME=ORCLPDB1.localdomain)))'
           @$2 $3;
           exit;
EOF
            ;;
      "hr")
    	   ...
    	   WHENEVER OSERROR EXIT 9;
    	   WHENEVER SQLERROR EXIT SQL.SQLCODE;
           conn HR/HR@'(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.5.15)(PORT=1521))(CONNECT_DATA = (SERVICE_NAME=ORCLPDB1.localdomain)))'
           @$2 $3;
           exit;
EOF
            ;;
      "sys")
    	   ...
    	   WHENEVER OSERROR EXIT 9;
    	   WHENEVER SQLERROR EXIT SQL.SQLCODE;
           conn SYS/Oradoc_db1@'(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.5.15)(PORT=1521))(CONNECT_DATA = (SERVICE_NAME=ORCLPDB1.localdomain)))' as SYSDBA
           @$2 $3;
           exit;
EOF
    esac
