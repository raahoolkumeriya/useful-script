...
prompt ---------------------------------------------------;
prompt -- integrated, high-performance database file system and disk manager.;
prompt -- ASM is based on the principle that the database should manage storage instead of requiring an administrator to do it.;
prompt ---------------------------------------------------;
